 ...
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        | LGUI | LAlt | Nav  |Bksp/ | Sym  |  |Enter | Space| AltGr|  ←   |  →   |
 *                        |      |      |      | Ctrl |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 */
    ...
    [_QWERTY] = LAYOUT(
     ...
     KC_LSFT, KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , KC_LBRC, KC_DOWN,              KC_UP , KC_RBRC, KC_N,   KC_M ,KC_COMM, KC_DOT ,KC_SLSH, KC_RSFT,
                                KC_LGUI, KC_LALT, NAV, LCTL_T(KC_BSPC), SYM,     KC_ENT, KC_SPC ,KC_ALGR, KC_LEFT, KC_RGHT
    ),
