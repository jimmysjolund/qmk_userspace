 ...
 * `-----------------------------------------------------------------------------------'
 */
/* Qwerty - jimmysjolund 2025-03-26
 * ,-----------------------------------------------------------------------------------.
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Alt  | GUI  | LAlt |Raise |Bksp/ |Lower |Enter |Space |AltGr | Alt  | Left |Right |
 * |      |      |      |      | Ctrl |      |      |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LALT,  KC_LGUI, KC_LALT,  RAISE, LCTL_T(KC_BSPC), LOWER,  KC_ENT,  KC_SPC,  KC_ALGR,  KC_LALT,  KC_LEFT,  KC_RGHT
),
